...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 500px;
    width: 1263px;
    background:url(uploadimg/ECE.png);
}
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Connect Learning</h1>
			</div>
 					...
 					<div class="row">
 						<div class="col-xs-12">
 							<div class="section-title text-center">
 								<h2><b> Electronics and Communication</b></h2>
 								<div class="sub-heading">
 									Following are the available Electronics and Communication <br>
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="140" height="37" srcset="images/agency/logo-retina-inverse-280x74.png 2x"></a>
                <p>Connect Learning is an excellent learning hub, dedicated to the Electronics and Communication who want to explore.</p>
                <!-- Rights-->
            ...
            <div class="col-md-4">
              ...
              <dl class="contact-list">
                <dt>Address:</dt>
                <dd>gurudev kanpur</dd>
              </dl>
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">rameshmaurya553@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>phones:</dt>
                <dd><a href="tel:#">+91 8601953149</a> <span>or</span> <a href="tel:#">+91 6388857182</a>
                </dd>
              </dl>
            </div>
